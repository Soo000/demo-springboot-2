package com.alisls.demo.springboot.elasticsearch.transport.lucene;
...
public class LuceneService {
     ...
     * @param jsonDoc
     */
    public void indexDoc(String indexDir, String jsonDoc) {
        IndexWriter writer = null;
        try {
            //准备目录
            Directory directory = FSDirectory.open(Paths.get((indexDir)));
     ...
     * @return
     */
    public String query(String indexDir, String queryStr) {
        String result = "";
